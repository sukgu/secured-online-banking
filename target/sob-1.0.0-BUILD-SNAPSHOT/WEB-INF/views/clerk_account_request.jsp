...
<tr>
<th>${request.fname} ${request.lname}</th>
<th>${request.account_type}</th>
<th><a href="<c:url value="approve_account" ><c:param name="id" value="${request.cust_id}"></c:param></c:url>">APPROVE</a></th>
<th><a href="<c:url value="reject_account" ><c:param name="id" value="${request.cust_id}"></c:param></c:url>">REJECT</a></th>
<th><a href="<c:url value="delete_account" ><c:param name="id" value="${request.cust_id}"></c:param></c:url>">DELETE</a></th>
</tr>
</c:forEach>
</table>
